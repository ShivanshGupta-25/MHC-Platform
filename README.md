...
```
cd existing_repo
git remote add origin https://gitlab.com/sugarcube08/mhc-chatbot.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sugarcube08/mhc-chatbot/-/settings/integrations)
